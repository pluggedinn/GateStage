...
export const EFFECT_CATALOG: EffectDef[] = [
    ...
    params: [
      {
        ...
        step: 100,
        default: 1000,
        entityName: "FX Pulse Transition",
      },
      {
        ...
        step: 100,
        default: 1000,
        entityName: "FX Pulse Cycle Interval",
      },
      {
        key: "min_brightness",
        ...
        step: 1,
        default: 0,
        entityName: "FX Pulse Min Brightness",
      },
      {
        key: "max_brightness",
        ...
        step: 1,
        default: 100,
        entityName: "FX Pulse Max Brightness",
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        step: 10,
        default: 100,
        entityName: "FX Color Wipe Interval",
      },
      {
        key: "reverse",
        ...
        type: "bool",
        default: false,
        entityName: "FX Color Wipe Reverse",
      },
    ],
  },
  {
  ...
  {
    id: "addressable_comet",
    name: "Comet",
    category: "strip",
    description: "Strip stays the chosen color; a brighter band travels on top",
    supportsColor: true,
    params: [
      {
        key: "width",
      ...
      },
      {
        ...
        step: 1,
        default: 100,
        entityName: "FX Comet Max Brightness",
      },
      {
        key: "reverse",
        label: "Reverse direction",
